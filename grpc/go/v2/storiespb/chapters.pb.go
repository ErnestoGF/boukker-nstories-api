...
type ResponseReadChapter struct {
	...
	Reactions          []*ReactionInfo `protobuf:"bytes,9,rep,name=Reactions,proto3" json:"Reactions,omitempty"`
...
type ReactionInfo struct {
	...
	ID   string       `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`
	Type ReactionType `protobuf:"varint,2,opt,name=Type,proto3,enum=stories.ReactionType" json:"Type,omitempty"`
}
...
var file_chapters_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x74,
