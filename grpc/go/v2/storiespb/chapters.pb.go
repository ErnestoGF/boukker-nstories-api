...
// RequestChangeChapterStatus ...
type RequestChangeChapterStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RequestChangeChapterStatus) Reset() {
	*x = RequestChangeChapterStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *RequestChangeChapterStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestChangeChapterStatus) ProtoMessage() {}

func (x *RequestChangeChapterStatus) ProtoReflect() protoreflect.Message {
	mi := &file_chapters_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestChangeChapterStatus.ProtoReflect.Descriptor instead.
func (*RequestChangeChapterStatus) Descriptor() ([]byte, []int) {
	return file_chapters_proto_rawDescGZIP(), []int{1}
}

func (x *RequestChangeChapterStatus) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *RequestChangeChapterStatus) GetStatus() StatusType {
	if x != nil {
		return x.Status
	}
	return StatusType_ST_IGNORE
...
var file_chapters_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x53, 0x74, 0x6f, 0x72, 0x79, 0x49, 0x44, 0x22, 0x59, 0x0a,
	0x1a, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x68,
	0x61, 0x70, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x44, 0x12, 0x2b, 0x0a, 0x06, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x73, 0x74,
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x40, 0x5a, 0x3e, 0x67, 0x69, 0x74, 0x68,
...
var file_chapters_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_chapters_proto_goTypes = []interface{}{
	(*RequestWriteChapter)(nil),        // 0: stories.RequestWriteChapter
	(*RequestChangeChapterStatus)(nil), // 1: stories.RequestChangeChapterStatus
	(StatusType)(0),                    // 2: stories.StatusType
}
var file_chapters_proto_depIdxs = []int32{
	2, // 0: stories.RequestWriteChapter.Status:type_name -> stories.StatusType
	2, // 1: stories.RequestChangeChapterStatus.Status:type_name -> stories.StatusType
...
func file_chapters_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chapters_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestChangeChapterStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
